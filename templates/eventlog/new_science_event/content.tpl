<!-- Sciencelog New Event Template -->
<!-- JPRO 31/01/2006               -->

<form action="$G_LOCATION/$G_LEVEL/new_science_event" method="post">
	<input type="hidden" name="next_page_new_science_event" value="$G_LOCATION/$G_LEVEL/list_science_recs/$LOGNUM" />
	<input type="hidden" name="next_page_science_update_time" value="$G_LOCATION/$G_LEVEL/new_science_event/$LOGNUM" />
	<input type="hidden" name="next_page_science_current_time" value="$G_LOCATION/$G_LEVEL/new_science_event/$LOGNUM" />
...
<!--        <select name="time_second">  </select> --> <input type="hidden" name="time_second" value="0" />
	...
	<div class="row">
		<div class="row-buttons">
			<input type="submit" name="CMD_science_update_time" value="Update SCS Variables" />
			<input type="submit" name="CMD_science_current_time" value="Set to Current Time" />
		</div>
	</div>
	...
	<div class="row">
		<div class="row-buttons"><input type="submit" name="CMD_new_science_event" value="Add Event" /></div>
	</div>
</form>
